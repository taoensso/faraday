...
(deftest scan-lazy-seq
  (let [num-items 50
        ...
        [aws-creds _ client-config] (#'far/client-params *client-opts*)
        client (proxy [AmazonDynamoDBClient] [aws-creds client-config]
                 (scan [req]
                   (.scan this req)))
        ;;*client-opts* (assoc *client-opts* :client client)
        ]
